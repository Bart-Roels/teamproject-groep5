...
!(function (n) {
  ...
  function mt(t, e, n, a) {
    ...
    function o(t) {
      (n !== N && n !== f) || ((l = d[f]), (s = t.innerHTML.trim()), l && l._bAttrSrc ? (b(l.mData._)(a, s), r(l.mData.sort, t), r(l.mData.type, t), r(l.mData.filter, t)) : h ? (l._setter || (l._setter = b(l.mData)), l._setter(a, s)) : (a[f] = s)),
        f++;
    }
    var i,
      l,
          ...
          function (t) {
            return _e(
              ...
              function (n) {
                ...
                if (n.nodeName)
                  return (
                    (t = n._DT_RowIndex), (e = n._DT_CellIndex), t !== N ? (a[t] && a[t].nTr === n ? [t] : []) : e ? (a[e.row] && a[e.row].nTr === n.parentNode ? [e.row] : []) : (t = P(n).closest('*[data-dt-row]')).length ? [t.data('dt-row')] : []
                  );
