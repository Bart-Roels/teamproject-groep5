  ...
  return (function () {
  ...
  })()(
    {
          ...
          (function (r, n) {
            (function () {
              ...
              const i = e('events').EventEmitter,
                ...
                v = { keepalive: 60, reschedulePings: !0, protocolId: 'MQTT', protocolVersion: 4, reconnectPeriod: 1e3, connectTimeout: 3e4, clean: !0, resubscribe: !0 },
              ...
              h(T, i),
                (T.prototype._setupStream = function () {
                  ...
                  function s() {
                    ...
                    const t = i.shift();
                    if (t) y('work :: packet pulled from queue'), e._handlePacket(t, o);
                    else {
                  ...
                  y('_setupStream :: calling method to clear reconnect'),
                    ...
                    this.stream.on('close', function () {
                      ...
                      y('(%s)stream :: on close', e.options.clientId),
                        (t = e.outgoing) &&
                          (y('flushVolatile :: deleting volatile messages from the queue and setting their callbacks as error function'),
                  ...
                  if (
                    ((a.cmd = 'connect'),
                    this.topicAliasRecv && (a.properties || (a.properties = {}), this.topicAliasRecv && (a.properties.topicAliasMaximum = this.topicAliasRecv.max)),
                    S(this, a),
                ...
                (T.prototype._handlePacket = function (e, t) {
                  ...
                  if (5 === r.protocolVersion && r.properties && r.properties.maximumPacketSize && r.properties.maximumPacketSize < e.length)
                    return this.emit('error', new Error('exceeding packets size ' + e.cmd)), this.end({ reasonCode: 149, properties: { reasonString: 'Maximum packet size was exceeded' } }), this;
                ...
                (T.prototype.publish = function (e, t, r, n) {
                  ...
                  if (((r = g({ qos: 0, retain: !1, dup: !1 }, r)), this._checkDisconnecting(n))) return this;
                  const o = this,
                    s = function () {
                      let s = 0;
                      if ((1 === r.qos || 2 === r.qos) && null === (s = o._nextId())) return y('No messageId left'), !1;
                      const a = { cmd: 'publish', topic: e, payload: t, qos: r.qos, retain: r.retain, messageId: s, dup: r.dup };
                  ...
                  return (this._storeProcessing || this._storeProcessingQueue.length > 0 || !s()) && this._storeProcessingQueue.push({ invoke: s, cbStorePut: r.cbStorePut, callback: n }), this;
                }),
                (T.prototype.subscribe = function () {
                  ...
                  const c = function () {
                    ...
                    const n = { cmd: 'subscribe', subscriptions: r, qos: 1, retain: !1, dup: !1, messageId: t };
                  ...
                  return (this._storeProcessing || this._storeProcessingQueue.length > 0 || !c()) && this._storeProcessingQueue.push({ invoke: c, callback: o }), this;
                }),
                (T.prototype.unsubscribe = function () {
                  ...
                  const s = function () {
                    const t = e._nextId();
                    if (null === t) return y('No messageId left'), !1;
                    const o = { cmd: 'unsubscribe', qos: 1, messageId: t };
                    return (
                      'string' == typeof r ? (o.unsubscriptions = [r]) : Array.isArray(r) && (o.unsubscriptions = r),
                      ...
                      (e.outgoing[o.messageId] = { volatile: !0, cb: n }),
                ...
                (T.prototype.end = function (e, t, r) {
                  ...
                  return (
                    ...
                    (null != e && 'boolean' == typeof e) || ((r = t || C), (t = e), (e = !1), 'object' != typeof t && ((r = t), (t = null), 'function' != typeof r && (r = C))),
                    ...
                    this.disconnecting
                      ...
                      : (this._clearReconnect(),
                        ...
                        !e && Object.keys(this.outgoing).length > 0
                          ? (y('end :: (%s) :: calling finish in 10ms once outgoing is empty', n.options.clientId), this.once('outgoingEmpty', setTimeout.bind(null, i, 10)))
                          : (y('end :: (%s) :: immediately calling finish', n.options.clientId), i()),
                        this)
                  );
                }),
                ...
                (T.prototype.reconnect = function (e) {
                  ...
                  const t = this,
                    r = function () {
                      e ? ((t.options.incomingStore = e.incomingStore), (t.options.outgoingStore = e.outgoingStore)) : ((t.options.incomingStore = null), (t.options.outgoingStore = null)),
                ...
                (T.prototype._setupReconnect = function () {
                  ...
                  !e.disconnecting && !e.reconnectTimer && e.options.reconnectPeriod > 0
                    ? (this.reconnecting || (y('_setupReconnect :: emit `offline` state'), this.emit('offline'), y('_setupReconnect :: set `reconnecting` to `true`'), (this.reconnecting = !0)),
                ...
                (T.prototype._cleanUp = function (e, t) {
                  const r = arguments[2];
                  if ((t && (y('_cleanUp :: done callback provided for on stream close'), this.stream.on('close', t)), y('_cleanUp :: forced? %s', e), e))
                  ...
                  var n;
                  this.disconnecting || (y('_cleanUp :: client not disconnecting. Clearing and resetting reconnect.'), this._clearReconnect(), this._setupReconnect()),
                    null !== this.pingTimer && (y('_cleanUp :: clearing pingTimer'), this.pingTimer.clear(), (this.pingTimer = null)),
                    t && !this.connected && (y('_cleanUp :: (%s) :: removing stream `done` callback `close` listener', this.options.clientId), this.stream.removeListener('close', t), t());
                }),
                (T.prototype._sendPacket = function (e, t, r) {
                  ...
                  const n = (function (e, t) {
                    if (5 === e.options.protocolVersion && 'publish' === t.cmd) {
                      ...
                      if (e.topicAliasSend)
                        if (r) {
                          if (0 !== n.length && (y('applyTopicAlias :: register topic: %s - alias: %d', n, r), !e.topicAliasSend.put(n, r)))
                            return y('applyTopicAlias :: error out of range. topic: %s - alias: %d', n, r), new Error('Sending Topic Alias out of range');
                        } else
                          0 !== n.length &&
                            (e.options.autoAssignTopicAlias
                              ? (r = e.topicAliasSend.getAliasByTopic(n))
                                ? ((t.topic = ''), (t.properties = { ...t.properties, topicAlias: r }), y('applyTopicAlias :: auto assign(use) topic: %s - alias: %d', n, r))
                                : ((r = e.topicAliasSend.getLruAlias()), e.topicAliasSend.put(n, r), (t.properties = { ...t.properties, topicAlias: r }), y('applyTopicAlias :: auto assign topic: %s - alias: %d', n, r))
                              : e.options.autoUseTopicAlias && (r = e.topicAliasSend.getAliasByTopic(n)) && ((t.topic = ''), (t.properties = { ...t.properties, topicAlias: r }), y('applyTopicAlias :: auto use topic: %s - alias: %d', n, r)));
                ...
                (T.prototype._storePacket = function (e, t, r) {
                  ...
                  (0 === (n.qos || 0) && this.queueQoSZero) || 'publish' !== n.cmd
                    ? this.queue.push({ packet: n, cb: t })
                    : n.qos > 0
                    ? ((t = this.outgoing[n.messageId] ? this.outgoing[n.messageId].cb : null),
                ...
                (T.prototype._checkPing = function () {
                  y('_checkPing :: checking ping...'),
                    this.pingResp
                      ? (y('_checkPing :: ping response received. Clearing flag and sending `pingreq`'), (this.pingResp = !1), this._sendPacket({ cmd: 'pingreq' }))
                ...
                (T.prototype._handleConnack = function (e) {
                  ...
                  if ((clearTimeout(this.connackTimer), delete this.topicAliasSend, e.properties)) {
                    ...
                    e.properties.serverKeepAlive && t.keepalive && ((t.keepalive = e.properties.serverKeepAlive), this._shiftPingInterval()),
                      e.properties.maximumPacketSize && (t.properties || (t.properties = {}), (t.properties.maximumPacketSize = e.properties.maximumPacketSize));
                  }
                      ...
                      a.customHandleAcks(r, n, e, function (r, n) {
                        return (
                          ...
                          r
                            ? s.emit('error', r)
                            : -1 === l.indexOf(n)
                            ? s.emit('error', new Error('Wrong reason code for pubrec'))
                            : void (n
                                ? s._sendPacket({ cmd: 'pubrec', messageId: o, reasonCode: n }, t)
                          ...
                          i
                            ...
                            : (a || s.emit('message', r, n, e),
                              void s.handleMessage(e, function (e) {
                                if (e) return t && t(e);
                                s._sendPacket({ cmd: 'puback', messageId: o, reasonCode: a }, t);
                              }))
                        );
                      });
                      break;
                    ...
                    (function r() {
                      ...
                      t.once('close', o),
                        ...
                        (function e() {
                          ...
                          let i;
                          r
                            ? t._packetIdsDuringStoreProcessing[r.messageId]
                              ? e()
                              : t.disconnecting || t.reconnectTimer
                              ? n.destroy && n.destroy()
                              : ((i = t.outgoing[r.messageId] ? t.outgoing[r.messageId].cb : null),
                                ...
                                t.messageIdProvider.register(r.messageId) ? t._sendPacket(r) : y('messageId: %d has already used.', r.messageId))
                            : n.once('readable', e);
                        })();
                    })();
                }),
      ...
      5: [
              ...
              t.exports = u
                ? function (e, t) {
                    ...
                    const i =
                      ...
                      p = (function (e, t, r) {
                        const n = new a({ objectModeMode: e.objectMode });
                    ...
                    return (
                      f.readyState === f.OPEN ? (r = p) : ((r = r = s(void 0, void 0, t)), t.objectMode || (r._writev = v), d ? f.addEventListener('open', g) : (f.onopen = g)),
                      (r.socket = f),
                      d ? (f.addEventListener('close', y), f.addEventListener('error', b), f.addEventListener('message', m)) : ((f.onclose = y), (f.onerror = b), (f.onmessage = m)),
                      r
                    );
                  }
                : function (e, t) {
        ...
        { _process: 50, buffer: 17, debug: 18, duplexify: 20, 'readable-stream': 69, ws: 80 },
      ],
      6: [
        function (e, t, r) {
          'use strict';
      ...
      12: [
        function (e, t, r) {
          (function (r) {
            (function () {
              ...
              (void 0 !== r && 'browser' !== r.title) || 'function' != typeof __webpack_require__
                ? ((l.mqtt = e('./tcp')), (l.tcp = e('./tcp')), (l.ssl = e('./tls')), (l.tls = e('./tls')), (l.mqtts = e('./tls')))
                : ((l.wx = e('./wx')), (l.wxs = e('./wx')), (l.ali = e('./ali')), (l.alis = e('./ali'))),
                (l.ws = e('./ws')),
                (l.wss = e('./ws')),
                (t.exports = u),
                (t.exports.connect = u),
        ...
        { '../client': 1, '../store': 8, './ali': 2, './tcp': 3, './tls': 4, './ws': 5, './wx': 6, _process: 50, debug: 18, url: 76, xtend: 81 },
      ],
      13: [
        function (e, t, r) {
          'use strict';
          ...
          (function (t) {
            (function () {
              ...
              (r.kMaxLength = i),
                ...
                'undefined' != typeof Symbol && null != Symbol.species && s[Symbol.species] === s && Object.defineProperty(s, Symbol.species, { value: null, configurable: !0, enumerable: !1, writable: !1 }),
                (s.poolSize = 8192),
              ...
              (s.prototype.slice = function (e, t) {
                ...
                (s.prototype.copy = function (e, t, r, n) {
                  ...
                  else if (this === e && r < t && t < n) for (var o = i - 1; o >= 0; --o) e[o + t] = this[o + r];
              ...
              s(f, i.Duplex),
                ...
                (f.prototype.setWritable = function (e) {
                  if ((this._unwrite && this._unwrite(), this.destroyed)) e && e.destroy && e.destroy();
                    ...
                    var t = this,
                      n = o(e, { writable: !0, readable: !1 }, c(this, this._forwardEnd)),
                      i = function () {
                        var e = t._ondrain;
                        (t._ondrain = null), e && e();
                      };
                ...
                (f.prototype.setReadable = function (e) {
                  if ((this._unread && this._unread(), this.destroyed)) e && e.destroy && e.destroy();
                    ...
                    var t,
                      r = this,
                      n = o(e, { writable: !1, readable: !0 }, c(this)),
                      s = function () {
                        r._forward();
                      },
                      a = function () {
                    ...
                    (this._drained = !0),
                      (this._readable = e),
                      (this._readable2 = e._readableState ? e : ((t = e), new i.Readable({ objectMode: !0, highWaterMark: 16 }).wrap(t))),
                ...
                (f.prototype.end = function (e, t, r) {
                  return 'function' == typeof e
                    ...
                    : 'function' == typeof t
                    ? this.end(e, null, t)
                    : ((this._ended = !0), e && this.write(e), this._writableState.ending || this._writableState.destroyed || this.write(l), i.Writable.prototype.end.call(this, r));
                }),
                (t.exports = f);
            }.call(this));
          }.call(this, e('_process'), e('buffer').Buffer));
        },
        { _process: 50, buffer: 17, 'end-of-stream': 21, inherits: 24, 'readable-stream': 69, 'stream-shift': 74 },
      ],
      21: [
        function (e, t, r) {
          (function (r) {
                ...
                o = function (e, t, s) {
                  ...
                  return (
                    !(function (e) {
                      ...
                      : (e.on('complete', p), e.on('abort', b), e.req ? v() : e.on('request', v)),
                    (function (e) {
            ...
            (s.prototype.emit = function (e) {
              ...
              switch ((n = arguments.length)) {
                case 1:
                  !(function (e, t, r) {
                    if (t) e.call(r);
                    else for (var n = e.length, i = y(e, n), o = 0; o < n; ++o) i[o].call(r);
                  })(r, u, this);
                  break;
                case 2:
                  !(function (e, t, r, n) {
                    if (t) e.call(r, n);
                    else for (var i = e.length, o = y(e, i), s = 0; s < i; ++s) o[s].call(r, n);
                  })(r, u, this, arguments[1]);
                  break;
                case 3:
                  !(function (e, t, r, n, i) {
                    if (t) e.call(r, n, i);
                    else for (var o = e.length, s = y(e, o), a = 0; a < o; ++a) s[a].call(r, n, i);
                  })(r, u, this, arguments[1], arguments[2]);
                  break;
                case 4:
                  !(function (e, t, r, n, i, o) {
                    if (t) e.call(r, n, i, o);
                    else for (var s = e.length, a = y(e, s), l = 0; l < s; ++l) a[l].call(r, n, i, o);
                ...
                default:
                  ...
                  !(function (e, t, r, n) {
                    if (t) e.apply(r, n);
                    else for (var i = e.length, o = y(e, i), s = 0; s < i; ++s) o[s].apply(r, n);
                  })(r, u, this, i);
              }
              return !0;
            }),
                ...
                t = Math.abs(t),
                  isNaN(t) || t === 1 / 0
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      (t += s + h >= 1 ? f / l : f * Math.pow(2, 1 - h)) * l >= 2 && (s++, (l /= 2)),
                      s + h >= c ? ((a = 0), (s = c)) : s + h >= 1 ? ((a = (t * l - 1) * Math.pow(2, i)), (s += h)) : ((a = t * Math.pow(2, h - 1) * Math.pow(2, i)), (s = 0)));
                i >= 8;
            ...
            return (
              (e.prototype.rotateLeft = function () {
                ...
                var i = n.leftChild,
                  o = n.rightChild;
                return (
                  e && (e.leftChild === this ? (e.leftChild = n) : e.rightChild === this && (e.rightChild = n)),
                  (n.parent = e),
                  (n.brother = t),
                  (n.leftChild = this),
                  (n.rightChild = o),
              ...
              (e.prototype.rotateRight = function () {
                ...
                var n = this.rightChild,
                  ...
                  o = r.rightChild;
                return (
                  e && (e.leftChild === this ? (e.leftChild = r) : e.rightChild === this && (e.rightChild = r)),
                  (r.parent = e),
                  (r.brother = t),
                  (r.leftChild = i),
                  (r.rightChild = this),
        ...
        function (e, t, r) {
          ...
          function i(e) {
            ...
            var h = function (e) {
              ...
              return { curNodeBucketIndex: Math.floor(r / i.bucketSize), curNodePointerIndex: r % i.bucketSize };
            };
            ...
            (this.pushBack = function (e) {
              ...
              (this.insert = function (e, t, r) {
                var n = this;
                if ((void 0 === r && (r = 1), 0 === e)) for (; r--; ) this.pushFront(t);
                else if (e === this.size()) for (; r--; ) this.pushBack(t);
                else {
              ...
              (r =
                ...
                function (e) {
                  var t,
                    ...
                    n = 0,
                    o = '';
                  if ('number' == typeof e) (n = ((n = Math.floor(e)) << 5) - n), (n &= n);
                  else {
            ...
            (this.setElement = function (e, t) {
              ...
              if (null !== t && void 0 !== t) {
                ...
                if (c[f]) {
                  ...
                  var b = c[f].size();
                  u += b - p;
                } else ++u, (c[f] = new o.default([{ key: e, value: t }]));
                u > h * a.sigma &&
                  function (e) {
                    if (!(e >= a.maxSize)) {
                      h = 2 * e;
              ...
              (this.eraseElementByKey = function (e) {
                ...
                if (c[l]) {
                  var f = c[l].size();
                  if (c[l] instanceof s.default) c[l].eraseElementByKey(e), c[l].size() <= a.untreeifyThreshold && (c[l] = new o.default(c[l]));
                  else {
                    var p = -1;
                    try {
            ...
            if (
              ...
              (r =
                ...
                function (e) {
                  var t = 0,
                    r = '';
                  if ('number' == typeof e) (t = ((t = Math.floor(e)) << 5) - t), (t &= t);
                  else {
      ...
      30: [
        function (e, t, r) {
          ...
          function s(e, t) {
            ...
            var h = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value) return t(e.key, r) <= 0 ? h(e.rightChild, r) : h(e.leftChild, r) || { key: e.key, value: e.value };
            };
            ...
            var p = function (e, r) {
              if (e && void 0 !== e.key && void 0 !== e.value) return t(e.key, r) >= 0 ? p(e.leftChild, r) : p(e.rightChild, r) || { key: e.key, value: e.value };
            };
            ...
            var b = function (e, r) {
                ...
                return n < 0
                  ? e.leftChild
                    ? b(e.leftChild, r)
                    : ((e.leftChild = new o.default()), (e.leftChild.parent = e), (e.leftChild.brother = e.rightChild), e.rightChild && (e.rightChild.brother = e.leftChild), e.leftChild)
                  : n > 0
                  ? e.rightChild
                    ? b(e.rightChild, r)
                    : ((e.rightChild = new o.default()), (e.rightChild.parent = e), (e.rightChild.brother = e.leftChild), e.leftChild && (e.leftChild.brother = e.rightChild), e.rightChild)
                  : e;
              },
              m = function (e) {
                var t = e.parent;
                ...
                if (t.color !== o.default.TreeNodeColorType.black && t.color === o.default.TreeNodeColorType.red) {
                  var r = t.brother,
                    n = t.parent;
                  if (!n) throw new Error('unknown error');
                  if (r && r.color === o.default.TreeNodeColorType.red) (r.color = t.color = o.default.TreeNodeColorType.black), (n.color = o.default.TreeNodeColorType.red), m(n);
            ...
            var w = function (e) {
              return n(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), [4, { key: e.key, value: e.value }];
                  case 2:
              ...
              d = function (e) {
                ...
                if (t.color !== o.default.TreeNodeColorType.black && t.color === o.default.TreeNodeColorType.red) {
                  var r = t.brother,
                    n = t.parent;
                  if (!n) throw new Error('unknown error');
                  if (r && r.color === o.default.TreeNodeColorType.red) (r.color = t.color = o.default.TreeNodeColorType.black), (n.color = o.default.TreeNodeColorType.red), d(n);
                  else if (!r || r.color === o.default.TreeNodeColorType.black)
                    if (t === n.leftChild) {
                      if (e === t.leftChild) {
                        (t.color = o.default.TreeNodeColorType.black), (n.color = o.default.TreeNodeColorType.red);
      ...
      36: [
        ...
        { './Deque/Deque': 26, './HashMap/HashMap': 27, './HashSet/HashSet': 28, './LinkList/LinkList': 29, './Map/Map': 30, './PriorityQueue/PriorityQueue': 31, './Queue/Queue': 32, './Set/Set': 33, './Stack/Stack': 34, './Vector/Vector': 35 },
      ],
      37: [
        function (e, t, r) {
          'use strict';
          ...
          (function (e) {
            (function () {
              ...
              (r.propertiesTypes = {
                ...
                (r.EMPTY = { pingreq: e.from([r.codes.pingreq << 4, 0]), pingresp: e.from([r.codes.pingresp << 4, 0]), disconnect: e.from([r.codes.disconnect << 4, 0]) });
            }.call(this));
          }.call(this, e('buffer').Buffer));
        },
        { buffer: 17 },
      ...
      43: [
        function (e, t, r) {
          ...
          class l extends i {
            ...
            parse(e) {
              for (
                this.error && this._resetState(), this._list.append(e), a('parse: current state: %s', this._states[this._stateCounter]);
            ...
            _parseConnect() {
              ...
              if (
                ((o.protocolVersion = this._list.readUInt8(this._pos)), o.protocolVersion >= 128 && ((o.bridgeMode = !0), (o.protocolVersion = o.protocolVersion - 128)), 3 !== o.protocolVersion && 4 !== o.protocolVersion && 5 !== o.protocolVersion)
              )
                return this._emitError(new Error('Invalid protocol version'));
              if ((this._pos++, this._pos >= this._list.length)) return this._emitError(new Error('Packet too short'));
              if (
                ((i.username = this._list.readUInt8(this._pos) & s.USERNAME_MASK),
                (i.password = this._list.readUInt8(this._pos) & s.PASSWORD_MASK),
                (i.will = this._list.readUInt8(this._pos) & s.WILL_FLAG_MASK),
                i.will && ((o.will = {}), (o.will.retain = 0 != (this._list.readUInt8(this._pos) & s.WILL_RETAIN_MASK)), (o.will.qos = (this._list.readUInt8(this._pos) & s.WILL_QOS_MASK) >> s.WILL_QOS_SHIFT)),
              ...
              if (((e.subscriptions = []), this._parseMessageId())) {
                ...
                for (; this._pos < e.length; ) {
                  ...
                  (n = (r = this._parseByte()) & s.SUBSCRIBE_OPTIONS_QOS_MASK),
                    ...
                    (u = { topic: t, qos: n }),
                    5 === this.settings.protocolVersion ? ((u.nl = l), (u.rap = o), (u.rh = i)) : this.settings.bridgeMode && ((u.rh = 0), (u.rap = !0), (u.nl = !0)),
            ...
            _parseProperties() {
              ...
              for (; this._pos < t; ) {
                ...
                if ('userProperties' !== t) r[t] ? (Array.isArray(r[t]) ? r[t].push(this._parseByType(s.propertiesTypes[t])) : ((r[t] = [r[t]]), r[t].push(this._parseByType(s.propertiesTypes[t])))) : (r[t] = this._parseByType(s.propertiesTypes[t]));
                else {
            ...
            _newPacket() {
              return (
                a('_newPacket'),
                this.packet &&
                  (this._list.consume(this.packet.length), a('_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d', this.packet.cmd, this.packet.payload, this.packet.length), this.emit('packet', this.packet)),
      ...
      44: [
                ...
                switch ((l('generate called'), t.cork && (t.cork(), a(b, t)), g && ((g = !1), h()), l('generate: packet.cmd: %s', e.cmd), e.cmd)) {
                  case 'connect':
                    return (function (e, t, i) {
                      ...
                      y += 1;
                      if (('string' == typeof h || r.isBuffer(h)) && (h || a >= 4) && (h || u)) y += r.byteLength(h) + 2;
                      else {
                  ...
                  case 'publish':
                    return (function (e, t, o) {
                      ...
                      const s = o ? o.protocolVersion : 4,
                        ...
                        g = a.properties;
                      let y = 0;
                      if ('string' == typeof h) y += r.byteLength(h) + 2;
                      else {
              ...
              function A(e, t, r) {
                ...
                for (const r in t)
                  if (Object.prototype.hasOwnProperty.call(t, r) && null !== t[r]) {
                    const n = t[r];
                    if (Array.isArray(n)) for (let t = 0; t < n.length; t++) x(e, r, n[t]);
                    else x(e, r, n);
                  }
              }
              function I(e) {
        ...
        { './constants': 38, './numbers': 41, buffer: 17, debug: 18, 'process-nextick-args': 49 },
      ],
      45: [
        function (e, t, r) {
          var n = 1e3,
          ...
          (s.prototype.equals = function (e) {
            ...
            (a.prototype.free = function (e) {
              ...
              if (r) {
                ...
                if (r === this.ss.front()) e + 1 === r.low ? --r.low : this.ss.insert(t);
                else {
          ...
          i(
            ...
            i(
              ...
              function (e, t, r) {
                var n, i, s, a;
                if (
                  ('string' == typeof t && ((i = 'not '), t.substr(!s || s < 0 ? 0 : +s, i.length) === i) ? ((n = 'must not be'), (t = t.replace(/^not /, ''))) : (n = 'must be'),
                  (function (e, t, r) {
      ...
      56: [
        ...
        { './_stream_readable': 58, './_stream_writable': 60, _process: 50, inherits: 24 },
      ],
      57: [
        function (e, t, r) {
          'use strict';
            ...
            (function () {
              ...
              function E(t, r, n) {
                (i = i || e('./_stream_duplex')),
                  ...
                  (this.decoder = null),
                  (this.encoding = null),
                  t.encoding && (h || (h = e('string_decoder/').StringDecoder), (this.decoder = new h(t.encoding)), (this.encoding = t.encoding));
              }
              function C(t) {
              ...
              function U(e, t) {
                return 0 === t.length
                  ? null
                  : (t.objectMode ? (r = t.buffer.shift()) : !e || e >= t.length ? ((r = t.decoder ? t.buffer.join('') : 1 === t.buffer.length ? t.buffer.first() : t.buffer.concat(t.length)), t.buffer.clear()) : (r = t.buffer.consume(e, t.decoder)),
                    r);
                var r;
              }
              function q(e) {
              ...
              (C.prototype.read = function (e) {
                ...
                if ((0 !== e && (t.emittedReadable = !1), 0 === e && t.needReadable && ((0 !== t.highWaterMark ? t.length >= t.highWaterMark : t.length > 0) || t.ended)))
                  return u('read: emitReadable', t.length, t.ended), 0 === t.length && t.ended ? q(this) : P(this), null;
                ...
                return (
                  ...
                  t.ended || t.reading ? u('reading or ended', (i = !1)) : i && (u('do read'), (t.reading = !0), (t.sync = !0), 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), (t.sync = !1), t.reading || (e = I(r, t))),
                  null === (n = e > 0 ? U(e, t) : null) ? ((t.needReadable = t.length <= t.highWaterMark), (e = 0)) : ((t.length -= e), (t.awaitDrain = 0)),
                ...
                (C.prototype.on = function (e, t) {
                  ...
                  return (
                    'data' === e
                      ...
                      : 'readable' === e &&
                        (i.endEmitted || i.readableListening || ((i.readableListening = i.needReadable = !0), (i.flowing = !1), (i.emittedReadable = !1), u('on readable', i.length, i.reading), i.length ? P(this) : i.reading || r.nextTick(N, this))),
                    n
                  );
                }),
      ...
      60: [
        ...
        { '../errors': 55, './_stream_duplex': 56, './internal/streams/destroy': 63, './internal/streams/state': 67, './internal/streams/stream': 68, _process: 50, buffer: 17, inherits: 24, 'util-deprecate': 78 },
      ],
      61: [
        function (e, t, r) {
          (function (r) {
            ...
            (function () {
              ...
              t.exports = {
                destroy: function (t, o) {
                  ...
                  return a || l
                    ? (o ? o(t) : t && (this._writableState ? this._writableState.errorEmitted || ((this._writableState.errorEmitted = !0), e.nextTick(i, this, t)) : e.nextTick(i, this, t)), this)
          ...
          t.exports = function e(t, r, o) {
            ...
            return (
              (function (e) {
                ...
                ? (t.on('complete', c), t.on('abort', d), t.req ? g() : t.on('request', g))
                  ...
                  ? (function (e) {
                      ...
                      return e.proto
                        ? function e(o) {
                            ...
                            for (var a in (t.push(o), n.push(s), o)) {
                              ...
                              else if (l instanceof Map) s[a] = new Map(i(Array.from(l), e));
                              else if (l instanceof Set) s[a] = new Set(i(Array.from(l), e));
                              else if (ArrayBuffer.isView(l)) s[a] = r(l);
                              else {
                                var u = t.indexOf(l);
                                s[a] = -1 !== u ? n[u] : e(l);
                              }
                      ...
                      function i(e, i) {
                        for (var o = Object.keys(e), s = new Array(o.length), a = 0; a < o.length; a++) {
                          ...
                          else if (ArrayBuffer.isView(u)) s[l] = r(u);
                          else {
                            var c = t.indexOf(u);
                            s[l] = -1 !== c ? n[c] : i(u);
                          }
                  ...
                  ? function e(n) {
                      ...
                      for (var o in n) {
                        ...
                        'object' != typeof s || null === s
                          ...
                          ? (i[o] = new Date(s))
                          : s instanceof Map
                          ? (i[o] = new Map(t(Array.from(s), e)))
                          : s instanceof Set
                          ? (i[o] = new Set(t(Array.from(s), e)))
      ...
      73: [
        function (e, t, r) {
          ...
          i.from && i.alloc && i.allocUnsafe && i.allocUnsafeSlow ? (t.exports = n) : (o(n, r), (r.Buffer = s)),
      ...
      76: [
        function (e, t, r) {
          ...
          (o.prototype.parse = function (e, t, r) {
            ...
            var H = v.indexOf('?');
            if (
              (-1 !== H ? ((this.search = v.substr(H)), (this.query = v.substr(H + 1)), t && (this.query = m.parse(this.query)), (v = v.slice(0, H))) : t && ((this.search = ''), (this.query = {})),
              v && (this.pathname = v),
            ...
            (o.prototype.format = function () {
              ...
              return (
                t && ':' !== t.substr(-1) && (t += ':'),
                this.slashes || ((!t || b[t]) && !1 !== o) ? ((o = '//' + (o || '')), r && '/' !== r.charAt(0) && (r = '/' + r)) : o || (o = ''),
                n && '#' !== n.charAt(0) && (n = '#' + n),
                a && '?' !== a.charAt(0) && (a = '?' + a),
                t +
                  o +
            ...
            (o.prototype.resolveObject = function (e) {
              ...
              return (
                (_ = _ || (r.host && S.length)) && !P && S.unshift(''),
